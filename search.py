...
def breadthFirstSearch(p):
    ...
    while not pQueue.isEmpty():
      ...
      """
      if bool(sList) and ('searchFxNeedReset' in dir(p) and p.searchFxNeedReset == True):
          pass
      elif bool(sList) and ('searchFxNeedReset' not in dir(p) or ('searchFxNeedReset' in dir(p) and p.searchFxNeedReset == False)):
          pass
      """
